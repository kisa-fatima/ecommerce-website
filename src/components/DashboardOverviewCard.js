...
import { getTotalItemsOrdered, getTotalRevenue } from '../services/databaseFunctions';
...
const DashboardOverviewCard = () => {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', gap: 24, flex: 1, minWidth: 0, flexWrap: 'wrap', justifyContent: 'flex-end' }}>
